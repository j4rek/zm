 ...
 * @copyright Copyright (c) 2008-2009 by Joseph Woolley, Steffen Konerow,
 * Jared White  & J. Max Wilson	@license http://www.xajaxproject.org/bsd_license.txt BSD License*//*
...
//SkipAIOrequire dirname(__FILE__) . '/support/xajaxEvent.inc.php';
//EndSkipAIOClass: xajaxEventPlugin		Plugin that adds server side event handling capabilities to xajax.  Events can	be registered, then event handlers attached.*/
