...
require_once(RUTA_BASE."class_template.php");
require_once(RUTA_BASE."kyron.php");
require_once(RUTA_BASE."pelao.php");
require_once(RUTA_BASE."j4son.php");
require_once(RUTA_BASE."BotonPago.php");
require_once(RUTA_BASE."mail.php");
/************** CONFIG ERRORES ****************/
define("DEBUG",1);
error_reporting(E_ALL & ~E_NOTICE ); # tipo de errores a desplegar
